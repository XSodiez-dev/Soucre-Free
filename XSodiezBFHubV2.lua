...
local function TweenObject(obj, time, properties)
    game:GetService("TweenService"):Create(obj, TweenInfo.new(time, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), properties):Play()
end
...
local userImage = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://107927250707151",
...
local function UpdatePercentage(percentage, step)
    TweenObject(progressBar, 0.5, {Size = UDim2.new(percentage / 100, 0, 0, 24)})
    UpdateStepText(step)
end
...
for step, keyframe in pairs(v2.Keyframes) do
    task.wait(keyframe[1])
    UpdatePercentage(keyframe[2], step)
end

UpdatePercentage(100, 4)
TweenObject(topLabel, 0.5, {TextTransparency = 1})
TweenObject(titleLabel, 0.5, {TextTransparency = 1})
TweenObject(bgFrame, 0.5, {BackgroundTransparency = 1})
TweenObject(progressBar, 0.5, {BackgroundTransparency = 1})
task.wait(0.5)
TweenObject(mainFrame, 0.25, {Size = UDim2.new(0, 0, 0, 0)})
task.wait(0.25)

local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/farehamhz/Fluent-UI/refs/heads/main/main.lua"))()
local v15 = v14:CreateWindow({
    Title = "XSodiez Hub",
    SubTitle = "     by xsodiez 123",
    TabWidth = 160,
    Theme = "Light",
    Acrylic = true,
...
v23.Size = UDim2.new(0, 40, 0, 40);
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=107927250707151";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/yjX44zQKuC");
    end
});
...
v14:Notify({
    Title = "Welcome !",
    Content = "Đã Tải Xong XSodiez Hub",
    Duration = 10
});